...
export default function ChatBot() {
  ...
  const panelStyle: React.CSSProperties = isMobile ? {
    ...
    animation: 'db-slide-bottom 0.3s cubic-bezier(0.23,1,0.32,1)',
  } : {
    ...
    <>
      ...
      {open && (
        <div style={panelStyle}>
          ...
          <div className="db-msg" style={{ flex: 1, minHeight: 0, overflowY: 'auto', padding: '14px 14px 6px', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {messages.map((m, i) => (
          ...
          <div style={{ padding: '10px 12px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', gap: 8, alignItems: 'center', background: '#04020a', flexShrink: 0, paddingBottom: 'max(10px, env(safe-area-inset-bottom))' }}>
